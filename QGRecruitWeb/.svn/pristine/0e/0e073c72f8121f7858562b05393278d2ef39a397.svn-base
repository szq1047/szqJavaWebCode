...
<script type="text/javascript">
	function checkFile() {
		...
		var allFileExt = ".doc|.docx|.pdf|.ppt|.pptx";
    ...
    <body>
        <div class="div_head">
            <span>
                <span style="float:left">当前位置是：资料管理->上传资料</span>
                <span style="float:right;margin-right: 8px;font-weight: bold">
                    <a style="text-decoration: none" href="ViewAllResServlet">【返回】</a>
                </span>
            </span>
        </div>
        <div></div>
