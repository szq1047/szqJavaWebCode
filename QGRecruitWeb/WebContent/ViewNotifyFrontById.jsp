...
%>
<%
	Notify notify = (Notify) request.getAttribute("notify");
	...
	<div class="page_style lanmupage page_l61">
		...
		<div class="main_box main_box_style">
			<div class="main_box_inner">
				...
				<div class="notify1">
					<div>
						<span><h2><%=notify.getNtfTitle()%></h2></span><br /> <span
							style="display: block; text-align: left"><%=notify.getNtfPublisher()%>
							<%=notify.getNtfPubDate().substring(0, 10)%></span>
					</div>
					<hr />
					<div>
						<div>
							<span class="tw_article"><%=notify.getNtfContent()%></span>
						</div>
					</div>
				</div>
			</div>
