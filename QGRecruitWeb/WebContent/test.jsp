...
<%
	...
	//判读是否已经上传了试卷，如果没有上传的话，则查看结果的功能是不能使用的。
	TestInfoBll testbll=new TestInfoBll();
	Object[] params={session.getAttribute("userName")};
	boolean isExists=testbll.isExistName("select count(*) from tb_test where test_Publisher=?",params);
	...
	<div class="page_style lanmupage page_l61">
			...
			<div class="top_box_inner">
				<div class="topcontent">
					<div class="weibo">
						...
						%>
						<a href="login.jsp" class="xinl">登录</a> <a href="Register.jsp"
							class="tengx">注册</a>
						<%
							} else {
						%>
		...
		<div class="main_box main_box_style">
			<div class="main_box_inner">
				...
				<div class="notify1">
					<div class="tit">
						<a href="AddTestFront.jsp">上传试题</a> <%if(isExists) {%>| <a href="ViewTestResultFront.jsp">查看结果</a><%} %>
					</div>
					<div class="con">
						<div>
								...
								<div style="font-size: 13px; margin: 10px 5px;">
									 <table class="table_a" border="1" width="100%">
										<tbody>
											...
											<%
												if (testtypelist.equals("") || testtypelist == null) {
											%>
											<tr>
											...
											<tr>
												...
												<td align="center"><%=testlist.get(i).getTestPubDate().substring(0,16)%></td>
												<td><a
													href="DownloadFileServlet?filename=<%=testlist.get(i).getTestPath()%>">下载</a></td>
											</tr>
											<%
												}
											%>
